...
def create_session(host_name, transfer_type, folder_name, session_name, ini_path):
...
def on_create():
    ...
    result = create_session(host_name, transfer_type, folder_name, session_name, ini_path)
